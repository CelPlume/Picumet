// EvilCharts（MIT）registry 组件，来源 https://evilcharts.com/docs/recharts/installation 的 "recharts-brush" item
// （上游路径 src/registry/ui/recharts-brush.tsx）。本地改动仅两处：
...
import { ChartStyle, getColorsCount, type ChartConfig } from "../ui/recharts-chart";
